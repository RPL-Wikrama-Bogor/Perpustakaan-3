...
<head>
  ...
  <!-- Custom favicon for Perpustakaan App -->
  {{-- <link rel="shortcut icon" href="../../assets/admin/img/library.ico" type="image/x-icon"> --}}
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Perpustakaan 2021</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
